...
export default function FutsalPage() {
  ...
  // Filtro fixo para categoria futsal
  const futsalFilter = {
    category: "Futsal",
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Chuteiras de Futsal</h1>
        <p className="text-muted-foreground">
          Chuteiras especializadas para quadra com máxima aderência e controle.
          Perfeitas para jogadores que buscam precisão e velocidade no futsal.
        </p>
      </div>
