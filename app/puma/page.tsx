...
export default function PumaPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Chuteiras Puma</h1>
        <p className="text-muted-foreground">
          Descubra a velocidade e inovação das chuteiras Puma. Design único e
          tecnologia avançada para jogadores que buscam o diferencial no campo.
        </p>
      </div>
