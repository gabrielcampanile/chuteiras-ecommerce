...
export default function CampoPage() {
  ...
  // Filtro fixo para categoria campo
  const campoFilter = {
    category: "Campo",
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Chuteiras de Campo</h1>
        <p className="text-muted-foreground">
          Chuteiras para grama natural com máximo desempenho e tecnologia
          avançada. Perfeitas para jogadores que buscam tração superior e
