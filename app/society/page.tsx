...
export default function SocietyPage() {
  ...
  // Filtro fixo para categoria society
  const societyFilter = {
    category: "Society",
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Chuteiras de Society</h1>
        <p className="text-muted-foreground">
          Chuteiras perfeitas para grama sintética com travas baixas e
          estabilidade. Ideais para jogadores que buscam conforto e durabilidade
          em campos sintéticos.
        </p>
      </div>
