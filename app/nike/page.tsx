...
export default function NikePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Chuteiras Nike</h1>
        <p className="text-muted-foreground">
          Explore toda a linha de chuteiras Nike. Tecnologia de ponta para
          elevar seu jogo com produtos de máxima qualidade e desempenho.
        </p>
      </div>
