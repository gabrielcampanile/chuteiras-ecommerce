...
export default function MizunoPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Chuteiras Mizuno</h1>
        <p className="text-muted-foreground">
          Tradição japonesa em chuteiras de alta qualidade. Mizuno oferece
          produtos artesanais com tecnologia de ponta para jogadores exigentes.
        </p>
      </div>
